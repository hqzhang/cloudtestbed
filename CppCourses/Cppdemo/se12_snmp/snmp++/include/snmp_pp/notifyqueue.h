...
=====================================================================*/
// $Id: notifyqueue.h,v 1.10 2005/09/22 14:05:59 katz Exp $
...
class DLLOPT CNotifyEvent
{
 public:
  ...
  int Callback(SnmpTarget &target, Pdu &pdu, int fd, int status);
...
class DLLOPT CNotifyEventQueue: public CEvents
{
  public:
    ...
    int get_notify_fd(const UdpAddress match_addr) const;
    int get_notify_fd(const int i = 0) const;
