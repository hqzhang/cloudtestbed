...
#ifndef	BBT_STRCHAR_H_
#define	BBT_STRCHAR_H_
...
namespace bbt {
 ...
 char *lsetField(char *target, size_t size, const char *src, const char fill = 0);
 char *rsetField(char *target, size_t size, const char *src, const char fill = 0);
